...
set(SHOULDER_INSTALL_DIR ${SCAPULA_AARCH64_INSTALL_PREFIX}/bin/shoulder)
...
add_dependency(
    ...
    INSTALL_COMMAND
        COMMAND ${CMAKE_COMMAND} -E copy_directory
            ...
            ${SCAPULA_AARCH64_INSTALL_PREFIX}/lib/python3/dist-packages/shoulder
        COMMAND ${CMAKE_COMMAND} -E copy_directory
            ${SHOULDER_BUILD_DIR}/scripts
            ${SCAPULA_AARCH64_INSTALL_PREFIX}/lib/python3/dist-packages/scripts
        COMMAND ${CMAKE_COMMAND} -E copy_directory
            ${SHOULDER_BUILD_DIR}/include
            ${SCAPULA_AARCH64_INSTALL_PREFIX}/lib/python3/dist-packages/include
        COMMAND ${CMAKE_COMMAND} -E copy_directory
            ${SHOULDER_SOURCE_DIR}/shoulder
            ${SCAPULA_AARCH64_INSTALL_PREFIX}/bin/shoulder
)
