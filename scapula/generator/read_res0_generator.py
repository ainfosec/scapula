...
class ReadRes0Generator(shoulder.generator.abstract_generator.AbstractGenerator):
    def generate(self, objects, outpath):
        # Gadget settings
        self.gadgets["scapula.gadget.testcase"].verbose = False
        self.gadgets["scapula.gadget.testcase"].prefix = "res0_test"
        ...
        # Generate this test
        outfile_path = os.path.abspath(os.path.join(outpath, "read_res0_tests.h"))
        shoulder.logger.info("Generating RES0 field tests")
        with open(outfile_path, "w") as outfile:
            self.gadgets["shoulder.include_guard"].name = "SCAPULA_RESERVED_0_TESTS_H"
